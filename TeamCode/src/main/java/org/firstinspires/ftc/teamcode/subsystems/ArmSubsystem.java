 ...
 *
 * The arm motor still has to be set to a port on the Control/Expansion Hub even if a servo is being
 * used instead because im lazy and don't want to disable the motor code
 *
